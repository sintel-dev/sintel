...
export class Matrix extends pip.Events {
    ...
    constructor(ele: HTMLElement, private data: Experiment, option?: Option) {
        ...
        self.option.width = _.isUndefined(self.option.width)
            ? self.minWidth
            : self.option.width;
        self.option.height = _.isUndefined(self.option.height)
            ? self.minHeight
            : self.option.height;
    ...
    private plot() {
        ...
        let g = self.svg
            ...
            .attr(
                "transform",
                `translate(${self.option.margin.left}, ${self.option.margin.top})`
            );
    ...
    private addAreaChart(g: d3.Selection<SVGGElement, any, any, any>) {
        ...
        let areaG = g
            ...
            .attr(
                "transform",
                `translate(${self.option.width - w}, ${h - 16})`
            );
        ...
        self.option.maxScore =
            self.option.maxScore > 6 ? 6 : self.option.maxScore;
    ...
    private addMatrixHeatmap(g: d3.Selection<SVGGElement, any, any, any>) {
        ...
        let cg = g
            ...
            .attr(
                "transform",
                `translate(${self.option.width - w}, ${self.option.height - h})`
            );
        ...
        cg.selectAll(".cell")
            ...
            .attr(
                "y",
                (d, i) =>
                    (size + fx.paddingInner() * 1.2) * Math.trunc(i / rowNum)
            )
            .attr("width", size)
            .attr("height", size)
