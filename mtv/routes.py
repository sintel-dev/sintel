...
def add_routes(app):
    ...
    api.add_resource(
        ctrl.datarun.Datarun,
        '/api/v1/dataruns/<string:datarun>/')
    api.add_resource(ctrl.datarun.Dataruns, '/api/v1/dataruns/')

    api.add_resource(ctrl.pipeline.Pipeline,
    ...
    api.add_resource(
        ...
        '/api/v1/comments/<string:comment>/')
    api.add_resource(ctrl.comment.Comments, '/api/v1/comments/')

    api.add_resource(ctrl.data.Data, '/api/v1/data/')

    # experiment
    api.add_resource(ctrl.experiment.Experiment,
                     '/api/v1/experiments/<string:experiment>/')
